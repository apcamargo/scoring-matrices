...
PFASUM31, PFASUM43, PFASUM45, PFASUM51, PFASUM59, PFASUM60, PFASUM67, PFASUM78
    A family of protein scoring matrices computed from Pfam alignments by Keul,
    Hess, Goesele, and Hamacher (2017).

    .. versionadded:: 0.3.4

EDNAFULL
    Extended version of NUC.4.4 with support for U residues.
...
DAYHOFF
    An alias for the PAM250 with additional B, Z, X and \* scores.

GONNET
    PAM250 matrix recommended by Gonnet, Cohen & Benner (1992).

NUC.4.4
    The extended DNA scoring matrix created by Todd Lowe (1992).
...
VTML10, VTML20, VTML40, VTML80, VTML120, VTML160
    ...
    to improve estimation of exchange frequencies. VTML80 is used by MMseqs2 for
    the k-mer generation process.
